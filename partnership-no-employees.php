                        ...
                        <form id="form-data">
                            <div id="flow-1">
                                ...
                                <div id="4800-1" style="display:none;">
                                    <label id="4800-label">Do you have income on line 4c or 14a of your 2019 or 2020 K-1 from the partnership?
                                    </label>
                                ...
                                <div id="no" style="display:none">You are not eligible for a PPP loan.
                                </div>
                            ...
                            <div id="first">
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        <label id="Email1Label" for="phone" class="Label"><b>Mobile Phone</b></label> 
                                        <input id="phone" class="phone form-control" name="phone" maxlength="255" type="phone" onfocus="" onblur="" onchange="">
                            ...
                            <div id="second">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label for="num_employees"><b>Number Of Partners?</b></label>
                                ...
                                <hr>
                                <label><b>Needed Documents</b><br>
                                    Copy of your filed 2019 or 2020 partnership tax return <br>
                                </label>
                                ...
                                <p>Pictures of driver's licenenses (front and back) of each partner who ownes more than 20% - cannot be expired (passport is ok)<br>
                                </p>
                                <div class="file-upload-wrapper-2">
                                    <label class="file-field-2" data-max-files="6">
                                        <br>
                                    ...
                                    <p>Please upload your articles of incorporation and Form 4506-c</p>
                                <div class="file-upload-wrapper-2">
                                    <label class="file-field-2" data-max-files="6">
                                        <br>
                                        <h4 class="drag-zone">Drop files to upload or</h4>
                            ...
                            <div id="second-b">
                                ...
                                Please list any owners with greater than 20% ownership
                                <div class="form-group">
...
<script type="text/javascript">
    ...
    $('#payroll, #num_employees').on("keyup change", function() {
        ...
        var sum = payroll / employees * 2.5;
        if (payroll / employees > 100000) {
            sum = 100000 * employees;
        }
        $('#loan_amount').val(sum);
    });
