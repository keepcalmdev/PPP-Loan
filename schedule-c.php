                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 bg-white p-4 rounded mt-5">
                        ...
                        <div class="test-center text-dark well mb-2 p-2 rounded lead" id="final">
                            ...
                            <p> Please be ready for a follow up call shortly</p>
                        </div>
                        ...
                        <form id="form-data">
                            <div id="flow-1">
                                ...
                                <div id="4800-1" style="display:none;">
                                    <label id="4800-label">Do you have income greater than $4800 on line 7 of your 2019 or 2020 schedule C of your personal tax return?
                                    </label>
                            ...
                            <div id="second">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col"> <label for="payroll"><b>Line 7 of your 2019 or 2020 schedule C of your personal tax return</b></label>
                                            <input type="text" class="form-control" name="line-7" placeholder="$" id="payroll">
                                            <b></b>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <label for="loan_amount"><b>Estimated Loan Amount</b></label>
                                ...
                                <label><b>Required Documents</b><br>Please upload the following:
                                    Copy of your filed 2019 or 2020 personal tax return
                                </label>
                                <div class="file-upload-wrapper">
                                    ...
                                    <p>Pictures of driver's licenenses (front and back)</p>
                                ...
                                <div class="file-upload-wrapper-2" id="monthly-gross-files" style="display:none">
                                    <div class="file-upload-wrapper-2">
                                        <label class="file-field-2" data-max-files="6">
                                            <br>
                                            <h4 class="drag-zone">Drop files to upload or</h4>
                            ...
                            <div id="third">
                                ...
                                <div class="form-group">
                                    <label for="email">Is the franchise listed in SBA’s Franchise Directory? </label>
                                    <select id="LoanNum5" name="q4" class="form-control">
                                        <option value="" selected="" disabled="true">* Required Field</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                ...
                                <div class="form-group">
                                    <a href="#" class="btn btn-default" id="prev-1">Previous</a>
...
<script type="text/javascript">
    ...
    $('select[name=Receive_ppp]').change(function() {
        if ($(this).val() == 'Yes') {
            ...
            $('#monthly-gross').show();
            $('#monthly-gross-files').show();
        } else {
            $('#required-files-yes').hide();
            $('#monthly-gross').hide();
            $('#monthly-gross-files').hide();
        }
    });
