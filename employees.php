...
<div id="ppp-1">
    ...
    <div class="col">
        ...
        <input id="email" class="Email form-control womplyTextField Required" name="email" maxlength="255" type="email" required><span style="font-size:12px; color:#646464; ">* Required Field</span> </div>
...
<div><label id="dateLabel" for="date" class="start-date">Start Date of Business</label>
        <input id="start-date" class=" form-control womplyTextField womplyRequired" name="start-date" maxlength="255" type="text" placeholder="mm/yy" required></div>
...
1) 2019 or 2020 filed corporate tax return (we get EIN, ownership including SS#, NAICS, start date, legal name, benefits from tax return)
2) Articles of incorporation (legal name and start date)
3) Pictures of driver's licenenses of each greater than 20% shareholder (front and back) - cannot be expired.  Passport is ok
4) Payroll reports for 2019 and for 2020 showing gross pay by employee per year (payments to 1099 do not count)
	a) alternative is forms 941, 940 (but need to confirm no one got paid more than $100k)</label>
...
8) Does your company contribute to employees retirement (e.g. 401k match)?  If so, please provide documentation of what the amount provided in 2019 and/or 2020</label>
...
$('#payroll').on("keyup change", function()  {
    if ($(this).val() > 2 ) {
        $('#loan_amount').val(sum)  * 2.5;
