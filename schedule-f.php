                    ...
                    <div class="col-md-8 bg-white p-4 rounded mt-5">
                        ...
                        <form id="form-data">
                            ...
                            <div id="second">
                                ...
                                <hr>
                                <label><b>Please upload the following:</b><br>
                                    Copy of your filed 2019 or 2020 personal tax return<br>
                                </label>
                                ...
                                <div id="file-upload-2" style="display:none">Provide backup to substantiate - (quickbooks p&l, bank statements, square/clover statements etc)
                                    <div class="file-upload-wrapper-2">
                                        <label class="file-field-2" data-max-files="6">
                                            <br>
                                            <h4 class="drag-zone">Drop files to upload or</h4>
