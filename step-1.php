...
?>
 ...
 <div id="page-container">
   <div id="content-wrap">
      ...
      <option value="Sole proprietor">Sole proprietor</option><option value="Partnership With Employees">Partnership With Employees</option>
      ...
      <option value="C-Corp">C-Corp</option><option value="S-Corp">S-Corp</option><option value="LLC Single Member No Employees">LLC Single Member No Employees</option>
      
      <option value="LLC Single With Employees">LLC With Employees</option>
      
      <option value="Independent contractor">Independent contractor</option><option value="Eligible self-employed individual">Eligible self-employed individual</option><option value="501(c)(3) nonprofit">501(c)(3) nonprofit</option><option value="501(c)(19) veterans organization">501(c)(19) veterans organization</option><option value="Tribal business (sec. 31(b)(2)(C) of Small Business Act)">Tribal business (sec. 31(b)(2)(C) of Small Business Act)</option><option value="Self-employed Farmer">Self-employed Farmer</option></select>
    </div>
<div id="schedule-f">
    <p>
...
$('select[name=Entity]').change(function () {
         if ($(this).val() == 'S-Corp' || $(this).val() == 'C-Corp'  || $(this).val() == 'LLC With Employees '  || $(this).val() == 'Partnership With Employees' ) {
...
$('select[name=Entity]').change(function () {
         if ($(this).val() == '501(c)(3) nonprofit' || $(this).val() == '501(c)(19) veterans organization' || $(this).val() == 'Tribal business (sec. 31(b)(2)(C) of Small Business Act)' ) {
...
$('select[name=Entity]').change(function () {
         if ($(this).val() == 'LLC Single Member No Employees' || $(this).val() == 'Sole proprietor' || $(this).val() == 'Partnership With Guaranteed Payments' || $(this).val() == 'Independant contractor' || $(this).val() == 'Eligible self-employed Farmer') {
